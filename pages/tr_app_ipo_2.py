...
default_symbols = "SPY,QQQ,PLTR,OPRA,IAS,XM,MNDY,LI,COCO,INTA,WEAV,RXST,DT,SMAR,DV,DUOL,AMAM,DDOG,CXM,INZY,LTH,NET,DSEY,NNOX,YMAB,ACVA,LQDA,BASE,ETNB,SIBN,VIST,TNYA,NU,CRWD,BSY,SCPL,CNM,ALGM,VERX,IOT,ONON,AI,CFLT,CRSR,INSP,SOVO,BRBR,FOUR,MORF,ESTC,LZ,DOLE,LFST,CVT,GLBE,TERN,VECT,UBER,ZUO,DOCN,PAX,FLYW,SWAV,ACLX,CRDO,APP,XP,KNSA,FROG,SPOT,GFL,BMEA,MLTX,FSLY,RXDX,MNTV,ZS,FLNC,OSCR,ARRY,ARLO,SDGR,IDYA,TMDX,S,SANA,PCOR,CABA,TME,TXG,RELY,CERT,RXRX,AVDX,HCP,PHAT,ORCC,STNE,FOCS,MIRM,BBIO,IQ,DBX,ASAN,PCVX,PATH,TMCI,AIP,PUBM,CRNX,RVMD,EH,LASR,AKRO,SQSP,AGS,PDD,CEPU,DOCU,DASH,TW,SHC,XPOF,PGNY,ACT,LEGN,RSKD,DICE,AZEK,PD,RBLX,TOST,ESMT,DNUT,EXAI,EPRT,VTYX,SWTX,FRSH,RCUS,BLCO,UPST,FIGS,NCNO,COGT,ABNB,SHLS,KRTX,RYAN,FORG,OM,TENB"
